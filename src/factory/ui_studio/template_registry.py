...
TEMPLATES: tuple[TemplateDescriptor, ...] = (
    TemplateDescriptor(
        "builder-command-center", "Builder Command Center",
        "Task/workstream orchestration overview with live approvals.",
        pages=("Dashboard",), widgets=("TaskQueueWidget", "ApprovalQueueWidget"),
        required_components=(
            "DataTable", "Badge", "ApprovalCard", "EventTimeline", "CommandPalette",
        ),
        realtime=True,
    ),
    TemplateDescriptor(
        "agent-zero-workstream-board", "Agent Zero Workstream Board",
        "Work-order board tracking managed-worker runs and evidence.",
        pages=("WorkstreamBoard",), widgets=("WorkOrderCardWidget", "EvidenceWidget"),
        required_components=("DataTable", "Badge", "ApprovalCard", "EventTimeline"),
        realtime=True,
    ),
    TemplateDescriptor(
        "ai-operations-hub", "AI Operations Hub",
        "Model routing, quota, and execution health overview.",
        pages=("OperationsHub",), widgets=("ModelRouteWidget", "QuotaWidget"),
        required_components=("EChartLine", "DataTable", "Badge", "ResourceGauge"),
        realtime=True,
    ),
    TemplateDescriptor(
        "worldmonitor-workspace", "WorldMonitor Workspace",
        "Intelligence feed and map panel for the WorldMonitor integration.",
        pages=("WorldMonitorWorkspace",), widgets=("IntelligenceFeedWidget", "MapPanelWidget"),
    ...
    TemplateDescriptor(
        ...
        pages=("AnalyticsDashboard",), widgets=("KpiWidget", "TrendWidget"),
    ...
    TemplateDescriptor(
        ...
        pages=("RepositoryIntelligence",), widgets=("DependencyGraphWidget", "HotspotWidget"),
        required_components=("FlowCanvas", "EChartHeatmap", "DataTable"),
    ),
    TemplateDescriptor(
        "system-architecture-canvas", "System Architecture Canvas",
        "Interactive service/dependency diagram.",
        pages=("ArchitectureCanvas",), widgets=("ServiceNodeWidget",),
        required_components=("FlowCanvas", "Dialog", "Badge"),
    ),
    TemplateDescriptor(
        "resource-monitor", "Resource Monitor",
        "Live CPU/memory/disk gauges over a bounded resource snapshot stream.",
        pages=("ResourceMonitor",), widgets=("CpuGaugeWidget", "MemoryGaugeWidget"),
        required_components=("ResourceGauge", "EChartLine"),
        realtime=True,
    ),
    TemplateDescriptor(
        "approval-evidence-console", "Approval / Evidence Console",
        "Operator console for reviewing evidence and approval decisions.",
        pages=("ApprovalConsole",), widgets=("ApprovalQueueWidget", "EvidenceWidget"),
        required_components=("ApprovalCard", "DataTable", "Dialog"),
        realtime=True,
    ),
    TemplateDescriptor(
        "map-intelligence-center", "Map Intelligence Center",
        "Layered map intelligence view.",
        pages=("MapIntelligenceCenter",), widgets=("MapLayerWidget",),
        required_components=("MapView", "DeckOverlay", "Sheet"),
        realtime=True,
    ),
    TemplateDescriptor(
        "3d-orb-interface", "3D Orb Interface",
        "A 3D ambient status orb reflecting live system state.",
        pages=("OrbInterface",), widgets=("OrbStateWidget",),
    ...
    TemplateDescriptor(
        ...
        pages=("AdminDashboard",), widgets=("UserTableWidget", "PermissionWidget"),
        required_components=("DataTable", "Dialog", "Badge"),
    ),
    TemplateDescriptor(
        "saas-shell", "SaaS Shell",
        "Billing/onboarding shell for a multi-tenant product.",
        pages=("SaasShell",), widgets=("BillingWidget", "OnboardingWidget"),
        required_components=("Card", "Tabs", "Toast"),
    ),
    TemplateDescriptor(
        "product-landing-page", "Product Landing Page",
        "A static marketing landing page.",
        pages=("LandingPage",), widgets=(), required_components=("Card", "MotionPanel", "Button"),
    ),
    TemplateDescriptor(
        "portfolio-showcase", "Portfolio / Showcase",
        "A static portfolio/showcase page.",
        pages=("Showcase",), widgets=(), required_components=("Card", "MotionPanel"),
    ),
    TemplateDescriptor(
        "custom-realtime-interface", "Custom Real-Time Interface",
        "A minimal scaffold for a bespoke real-time interface.",
        pages=("CustomRealtime",), widgets=("CustomEventWidget",),
