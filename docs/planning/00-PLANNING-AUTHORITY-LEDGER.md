...
| TRACE-RPH3 | `docs/planning/RPH3-TRACEABILITY.md` | Authoritative `01M-AC-01..32`/`01K-AC-01..25` acceptance mapping + `01M-DEC`/`01K-DEC` distinction + PH-3/PH-5/PH-7 disposition + Dec A/B | Plan (subordinate to `01M`/`01K`/`01R`) | RPH3 repair | **EXISTS** (repair R2) |
| VEP-RPH3 | `docs/planning/RPH3-VERIFICATION-EVIDENCE-PROMOTION.md` | Verification/evidence/promotion architecture; VR-RPH3-01..20 (cites TRACE-RPH3 AC/DEC ids); VM-2; `PROM-RPH3`; PH-5 gates `EG-PH5-*` excluded | Plan (subordinate to `01G`/MATRIX-VERIF) | RPH3 Pass 6 / repair R2 | **EXISTS** (20 VR rows) |
...
| XSC-RPH3 | `docs/planning/RPH3-CROSS-STORE-CONSISTENCY.md` | Crash-consistent cross-store protocol (runtime DB / security-spine / audit); audit-as-commit-point; every crash window; fail-closed; VR-RPH3-19 | Plan (subordinate to `01M §3.17`/`01K §3.2`) | RPH3 repair R3 | **EXISTS** (repair R3) |
| WIR-RPH3 | `docs/planning/RPH3-WATCHDOG-INTERVENTION-RECEIVER.md` | Watchdog intervention receiver: ownership, typed schemas, 7-command allowlist, expected-state, scope, idempotency, journaling, audit ordering, auth, failure, INERT commands, XSC class per command; no writable connection to Watchdog | Plan (subordinate to `01M §1/§3.2`/R1) | RPH3 repair R4/R8 | **EXISTS** (repair R4/R8) |
| AUDIT-RPH3 | `docs/verification/rph3-planning-audit.md` | Reproducible planning audit: commit/branch/date, exact commands + results, changed-file inventory, docs-only confirmation, manual/cross-doc/phase-ownership/cert-consistency checks, gaps, verdict | Report | RPH3 repair R11 | **EXISTS** (28/28) |
| CERT-v1-SUPERSEDED | `docs/planning/superseded/RPH3-CERT-v1-SUPERSEDED.md` | Retained INVALID v1 certificate body (historical; out of main reading path) | Report (superseded) | RPH3 repair R11 | **SUPERSEDED** (by CERT-RPH3 v2) |
...
| CERT-RPH3 | `docs/planning/RPH3-IMPLEMENTATION-READINESS-CERTIFICATE.md` | Authoritative v2 certificate: §0 supersession, §1 corrected body (audits C1–C17, verdict); v1 body relocated to superseded doc | Derived certification | RPH3 Pass 10 / repair R7/R11 | **EXISTS** (v2; verdict `RPH3_CERTIFIED_WITH_NONBLOCKING_GAPS`; v1 `1d3b860` superseded) |
